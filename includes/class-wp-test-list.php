 ...
 */
class WP_Test_List extends WP_List_Table
{
    /**
    ...
    {
        return array('blog_id','born','phone_number', 'address_line_2', 'unit', 'branch');
    }
    /**
    ...
    {
        global $wpdb;
        $data = $wpdb->get_results('SELECT * FROM wp_cardfile_users ', 'ARRAY_A');
        return $data;
        $data = array();
        $data[] = array(
            'id'          => 1,
