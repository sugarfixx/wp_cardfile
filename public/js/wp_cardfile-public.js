...
jQuery(document).ready(function(){
	...
	/*
	var loading = jQuery('#loadingDiv').modal('hide');
	jQuery("#cardfile").ajaxStart(function () {
		loading.modal('show');
	});
	jQuery("#cardfile").ajaxStop(function () {
		loading.modal('hide');
	});
	*/
	jQuery(".submit").click(function(e){
		...
		/*
		var p_fname = jQuery("#first_name").val();
		var p_lname = jQuery("#last_name").val();
		var p_mail = jQuery("#email").val();
		var p_phone = jQuery("#phone_number").val();
		var address1 = jQuery("#address_line_1").val();
		var address2 = jQuery('#address_line_2').val();
		var postal = jQuery('#postal_code').val();
		var city = jQuery('#city').val();
		var c_fname = jQuery('#child_first_name').val();
		var c_lname = jQuery('#child_last_name').val();
		var c_mail = jQuery("#child_email").val();
		var c_phone = jQuery("#child_phone_number").val();
